...
Future<List<Classe>> getAllClasses() async {
  Response response =
      await http.get(Uri.parse("http://10.0.2.2:8088/class/all"));
...
Future<List<Matier>> getAllMatiers() async {
  Response response =
      await http.get(Uri.parse("http://10.0.2.2:8088/matier/all"));
  List<dynamic> jsonResponse = jsonDecode(response.body);
...
Future addAbsence(Absence absence) async {
  Response response =
      await http.post(Uri.parse("http://10.0.2.2:8088/absence/add"),
...
Future updateAbsence(Absence absence) async {
  Response response =
      await http.put(Uri.parse("http://10.0.2.2:8088/absence/update"),
          headers: {"Content-type": "Application/json"},
          body: jsonEncode(<String, dynamic>{
...
Future deleteAbsence(int? id) {
  return http
      .delete(Uri.parse("http://10.0.2.2:8088/absence/delete?id=${id}"));
}

Future addMatier(Matier matier, int classId) async {
  Response response = await http.post(
      Uri.parse("http://10.0.2.2:8088/matier/add/$classId"),
      headers: {"Content-type": "Application/json"},
      body: jsonEncode(<String, dynamic>{
...
Future updateMatier(Matier matier) async {
  Response response =
      await http.put(Uri.parse("http://10.0.2.2:8088/matier/update"),
          headers: {"Content-type": "Application/json"},
          body: jsonEncode(<String, dynamic>{
...
Future deleteMatier(int id) {
  return http.delete(Uri.parse("http://10.0.2.2:8088/matier/delete?id=${id}"));
}

Future deleteClass(int id) {
  return http.delete(Uri.parse("http://10.0.2.2:8088/class/delete?id=${id}"));
}

Future addClass(Classe classe) async {
  Response response = await http.post(
      Uri.parse("http://10.0.2.2:8088/class/add"),
      headers: {"Content-type": "Application/json"},
      body: jsonEncode(<String, dynamic>{
...
Future updateClasse(Classe classe) async {
  Response response =
      await http.put(Uri.parse("http://10.0.2.2:8088/class/update"),
          headers: {"Content-type": "Application/json"},
          body: jsonEncode(<String, dynamic>{
